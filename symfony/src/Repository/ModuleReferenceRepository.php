 ...
 */
class ModuleReferenceRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return ModuleReference[] Returns an array of ModuleReference objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?ModuleReference
    {
        return $this->createQueryBuilder('m')
            ->andWhere('m.exampleField = :val')
            ->setParameter('val', $value)
